...
const EXERCISES = {
  putting: [
    ...
    {id:"p2",name:"Tap-In Confidence",difficulty:"Beginner",duration:10,emoji:"⭕",purpose:"Short-putt routine and confidence",desc:"Place 10 balls in a circle 30 cm from the hole, make all 10, then move to 60 cm.",label:"Consecutive made",max:20,facePos:"square",ballPos:"center"},
    ...
    {id:"p6",name:"Ladder to the Hole",difficulty:"Beginner",duration:10,emoji:"🪜",purpose:"Basic speed judgment",desc:"Putt one ball each from 2 m, 4 m, 6 m, 8 m, aiming to finish past the hole but within 1 m. Repeat the ladder 3 times.",label:"In zone (of 12)",max:12,facePos:"square",ballPos:"center"},
    {id:"p7",name:"Clock Drill",difficulty:"Intermediate",duration:15,emoji:"🕐",purpose:"Consistency from all angles",desc:"4 balls at 1 m around the hole like a clock. Complete the full circle without missing. Repeat 3 rounds.",label:"Consecutive made",max:12,facePos:"square",ballPos:"center"},
    {id:"p8",name:"Distance Ladder",difficulty:"Intermediate",duration:15,emoji:"📶",purpose:"Speed calibration",desc:"Putt to targets at 3 m, 6 m, 9 m. Score a point if ball stops within 1 club-length. 5 attempts each.",label:"Points earned",max:15,facePos:"square",ballPos:"center"},
    {id:"p9",name:"5-Footer Pressure",difficulty:"Intermediate",duration:15,emoji:"💪",purpose:"Pressure performance",desc:"Sink 5 in a row from 1.5 m. Every miss resets the count. Simulates competition pressure.",label:"Attempts to complete",max:20,facePos:"square",ballPos:"center"},
    ...
    {id:"p12",name:"100-Ball Putting",difficulty:"Advanced",duration:30,emoji:"💯",purpose:"Endurance and baseline",desc:"100 putts from 1 to 6 m mixing straight and breaking lines. Track every make.",label:"Holed",max:100,facePos:"square",ballPos:"center"},
    {id:"p13",name:"Pressure 18",difficulty:"Advanced",duration:25,emoji:"🏆",purpose:"Tournament simulation",desc:"18 pressure situations: 6 at 1.2 m, 6 at 1.8 m, 6 at 2.4 m. 2 pts for make, 1 for tap-in, 0 for 3-putt.",label:"Points",max:36,facePos:"square",ballPos:"center"},
    {id:"p14",name:"3-6-9 Circuit",difficulty:"Advanced",duration:20,emoji:"📐",purpose:"Scoring from short range",desc:"Make 3 from 1 m, 3 from 2 m, 3 from 3 m without missing. Each miss adds a penalty putt.",label:"Total putts",max:20,facePos:"square",ballPos:"center"},
    {id:"p15",name:"Lag Putt Marathon",difficulty:"Advanced",duration:25,emoji:"🎯",purpose:"Long putt distance control",desc:"15 putts from 12-15 m, all to different holes. Score 2 points for 2-putt range (within 1 m), 0 for anything further.",label:"Points",max:30,facePos:"square",ballPos:"center"},
  ],
  shortGame: [
    ...
    {id:"s9",name:"Uphill / Downhill Lies",difficulty:"Intermediate",duration:15,emoji:"⛰️",purpose:"Adapting to slope",desc:"Find an uphill and a downhill stance near the green. Hit 5 chips from each, focusing on solid contact and controlling distance despite the slope.",label:"Up and downs",max:10,facePos:"square",ballPos:"back"},
    ...
    {id:"s11",name:"Short Game Circuit",difficulty:"Advanced",duration:30,emoji:"🔄",purpose:"Full short game consistency",desc:"5 stations around the green at varying distances: chip, pitch, high flop, bunker, awkward lie. 5 balls each. Track up and downs at each.",label:"Up and downs",max:25,facePos:"square",ballPos:"center"},
  ...
  longGame: [
    ...
    {id:"l2",name:"Slow Motion Swings",difficulty:"Beginner",duration:10,emoji:"🐢",purpose:"Swing plane and sequencing",desc:"15 balls at 50% speed with a mid-iron. Keep the club on plane and finish in balance. Rate each swing 1 to 3.",label:"Balanced finishes",max:15,facePos:"square",ballPos:"center"},
    {id:"l3",name:"Feet Together",difficulty:"Beginner",duration:10,emoji:"🦵",purpose:"Balance and rhythm",desc:"15 balls with feet together using any iron. Forces correct weight transfer and natural rhythm.",label:"Clean contacts",max:15,facePos:"square",ballPos:"center"},
    ...
    {id:"l5",name:"Fairway Finder",difficulty:"Intermediate",duration:15,emoji:"🛣️",purpose:"Driver accuracy",desc:"10 tee shots with your driver to a defined fairway corridor. Track hits and which side you miss.",label:"Fairways hit",max:10,facePos:"square",ballPos:"forward"},
    ...
    {id:"l8",name:"Wedge Distance Ladder",difficulty:"Intermediate",duration:20,emoji:"📶",purpose:"Partial swing calibration",desc:"5 balls each at 50, 75 and 100% swing speed with your shortest wedge. Note how far each effort level carries — this becomes your personal distance chart.",label:"Within 5 m of intended",max:15,facePos:"square",ballPos:"center"},
    ...
    {id:"l11",name:"Full Bag Challenge",difficulty:"Advanced",duration:40,emoji:"🎒",purpose:"Whole bag consistency",desc:"2 shots with every club in your bag, longest to shortest. Rate each shot: 0 poor, 1 ok, 2 great.",label:"Points",max:18,facePos:"square",ballPos:"varies"},
    {id:"l12",name:"Driver Under Pressure",difficulty:"Advanced",duration:20,emoji:"😤",purpose:"Performance under stress",desc:"10 drivers to the narrowest corridor you can define. Simulate your tightest tee shot at home.",label:"Fairways hit",max:10,facePos:"square",ballPos:"forward"},
    {id:"l13",name:"Trouble Shots",difficulty:"Advanced",duration:25,emoji:"🌲",purpose:"Recovery shot skills",desc:"Simulate 10 trouble situations: punch under a branch, draw around an obstacle, fade over trouble. Rate each shot 0 (failed) to 2 (executed as planned).",label:"Points",max:20,facePos:"varies",ballPos:"varies"},
  ],
  mental: [
...
const PROGRAMS = [
  {
    ...
    technical:"A draw curves right-to-left because the clubface is closed relative to an inside-to-out swing path.",
    bulletKeys:["draw_b1","draw_b2","draw_b3","draw_b4"],
  ...
  },
  {
    ...
    technical:"A fade curves left-to-right because the clubface is slightly open relative to an outside-to-in swing path.",
    bulletKeys:["fade_b1","fade_b2","fade_b3","fade_b4"],
    steps:[{focusId:"longGame",exId:"l1"},{focusId:"longGame",exId:"l7"},{focusId:"longGame",exId:"l9"}],
  },
  {
    ...
    technical:"A slice happens when the clubface is open relative to the swing path at impact — the face matters more than the path.",
    bulletKeys:["slice_b1","slice_b2","slice_b3","slice_b4","slice_b5"],
  ...
  },
  {
    ...
    technical:"A punch reduces trajectory by delofting the clubface at address, not by swinging harder.",
    bulletKeys:["punchLow_b1","punchLow_b2","punchLow_b3","punchLow_b4"],
  ...
  },
  {
    ...
    technical:"A flop gets height from an open face and a committed swing — decelerating causes the miss, not the technique.",
    bulletKeys:["flopLob_b1","flopLob_b2","flopLob_b3","flopLob_b4"],
  ...
  },
  {
    ...
    technical:"Bunker shots are won or lost at the entry point into the sand, never at the ball itself.",
    bulletKeys:["bunker_b1","bunker_b2","bunker_b3","bunker_b4"],
  ...
  },
  {
    ...
    technical:"The yips combine a physical component (muscle tension) and a mental one (fear of missing) — chasing a mechanical fix usually makes it worse.",
    bulletKeys:["yips_b1","yips_b2","yips_b3","yips_b4"],
...
// Maps a selected weakness to the Program that most directly addresses it,
// so the Train screen can surface one relevant suggestion instead of leaving
// the weaknesses a player picked at signup completely unused. Not every
// weakness has a perfect match (e.g. "strategy" is broad), so this is a
// best-fit mapping rather than a strict 1:1 — still better than nothing.
const WEAKNESS_TO_PROGRAM = {
  driver:"punchLow", irons:"slice", wedges:"flopLob", putting:"yips",
  bunker:"bunker", mental:"yips", shortGame2:"flopLob", strategy:"draw",
};
...
const TR = {
  en: {
    ...
    per18Holes:"per 18 holes", downMeansImproving:"Line trending down = improving (fewer 3-putts)",
    ...
    programs:"Pre-Set Programs", steps:"steps", programSteps:"What's in this program", startProgram:"Start Program", programComplete:"Program Complete", saveAndNext:"Save & Next", exitProgram:"Exit Program", technicalPoint:"The technical point",
    prog_warmup_name:"Competition Warm-Up", prog_warmup_desc:"A structured pre-round sequence — short putts to build feel, a basic chip to find contact, an alignment check, a tempo-builder, then a routine reset. Small to big, body before swing, exactly how tour pros structure it.",
    prog_warmup_technical:"This is preparation, not practice — the goal is rhythm and feel, not swing changes.",
    warmup_b1:"Work short clubs to long: wedge, then iron, then driver", warmup_b2:"Start at half speed, build to full speed over the sequence", warmup_b3:"No swing thoughts — just rhythm and contact", warmup_b4:"Finish on the putting green, not the range",
    ...
    prog_draw_technical:"A draw curves right-to-left because the clubface is closed relative to an inside-to-out swing path.",
    draw_b1:"Align feet, hips, and shoulders slightly right of target", draw_b2:"Strengthen grip slightly — turn both hands a touch clockwise", draw_b3:"Swing along your body line, not at the target", draw_b4:"Let the curve happen — don't manually close the face at impact",
    draw_b1_left:"Align feet, hips, and shoulders slightly left of target", draw_b2_left:"Strengthen grip slightly — turn both hands a touch counter-clockwise",
    ...
    prog_fade_technical:"A fade curves left-to-right because the clubface is slightly open relative to an outside-to-in swing path.",
    fade_b1:"Align feet, hips, and shoulders slightly left of target", fade_b2:"Weaken grip slightly — turn both hands a touch counter-clockwise", fade_b3:"Swing along your body line, not at the target", fade_b4:"Let the face stay open a fraction longer through impact",
    fade_b1_left:"Align feet, hips, and shoulders slightly right of target", fade_b2_left:"Weaken grip slightly — turn both hands a touch clockwise",
    ...
    prog_slice_technical:"A slice happens when the clubface is open relative to the swing path at impact — the face matters more than the path.",
    slice_b1:"Fix the face first: strengthen your grip until you see 2-3 knuckles on your lead hand at address", slice_b2:"Start the downswing with your hips, not your shoulders", slice_b3:"Keep your trail elbow close to your body on the way down", slice_b4:"Aim at the target, not further left — aiming left makes the path worse", slice_b5:"Let your forearms rotate through impact instead of holding the face open",
    slice_b4_left:"Aim at the target, not further right — aiming right makes the path worse",
    ...
    prog_punchLow_technical:"A punch reduces trajectory by delofting the clubface at address, not by swinging harder.",
    punchLow_b1:"Play the ball slightly back in your stance", punchLow_b2:"Press your hands ahead of the clubhead at address", punchLow_b3:"Make a three-quarter backswing", punchLow_b4:"Keep the follow-through short and low",
    ...
    prog_flopLob_technical:"A flop gets height from an open face and a committed swing — decelerating causes the miss, not the technique.",
    flopLob_b1:"Open the clubface fully at address", flopLob_b2:"Use your highest-lofted wedge", flopLob_b3:"Make a longer, accelerating swing that slides under the ball", flopLob_b4:"Commit fully — never try to help the ball into the air",
    ...
    prog_bunker_technical:"Bunker shots are won or lost at the entry point into the sand, never at the ball itself.",
    bunker_b1:"Open the clubface before you take your grip", bunker_b2:"Aim 2-3cm behind the ball, not at it", bunker_b3:"Let the bounce skim through the sand — never dig", bunker_b4:"Pick your entry point and commit, even if you're nervous",
    ...
    prog_yips_technical:"The yips combine a physical component (muscle tension) and a mental one (fear of missing) — chasing a mechanical fix usually makes it worse.",
    yips_b1:"Rebuild confidence at very short range first (30cm putts)", yips_b2:"Slow your breathing before every single stroke", yips_b3:"Judge yourself on the routine, not whether it goes in", yips_b4:"Resist the urge to change grip or equipment mid-session",
  ...
  fr: {
    ...
    per18Holes:"sur 18 trous", downMeansImproving:"Courbe vers le bas = progres (moins de 3-putts)",
    ...
    programs:"Programmes Predefinis", steps:"etapes", programSteps:"Contenu du programme", startProgram:"Demarrer le programme", programComplete:"Programme termine", saveAndNext:"Enregistrer et suivant", exitProgram:"Quitter le programme", technicalPoint:"Le point technique",
    prog_warmup_name:"Echauffement de Competition", prog_warmup_desc:"Une sequence structuree avant le depart — putts courts pour le toucher, chip de base pour le contact, controle d'alignement, exercice de tempo, puis reinitialisation de routine. Du petit au grand, le corps avant le swing, exactement comme les pros du circuit s'organisent.",
    prog_warmup_technical:"C'est de la preparation, pas de l'entrainement — l'objectif est le rythme et le toucher, pas des changements de swing.",
    warmup_b1:"Travaillez du petit club au grand : wedge, puis fer, puis driver", warmup_b2:"Commencez a moitie vitesse, montez progressivement", warmup_b3:"Aucune pensee technique — juste rythme et contact", warmup_b4:"Terminez sur le green de putting, pas au practice",
    ...
    prog_draw_technical:"Un draw courbe de droite a gauche car la face du club est fermee par rapport a un plan de swing interieur-exterieur.",
    draw_b1:"Alignez pieds, hanches et epaules legerement a droite de la cible", draw_b2:"Renforcez legerement le grip — tournez les deux mains un peu dans le sens horaire", draw_b3:"Swinguez le long de votre ligne corporelle, pas vers la cible", draw_b4:"Laissez la courbe se produire — ne fermez pas la face manuellement a l'impact",
    draw_b1_left:"Alignez pieds, hanches et epaules legerement a gauche de la cible", draw_b2_left:"Renforcez legerement le grip — tournez les deux mains un peu dans le sens antihoraire",
    ...
    prog_fade_technical:"Un fade courbe de gauche a droite car la face du club est legerement ouverte par rapport a un plan de swing exterieur-interieur.",
    fade_b1:"Alignez pieds, hanches et epaules legerement a gauche de la cible", fade_b2:"Affaiblissez legerement le grip — tournez les deux mains un peu dans le sens antihoraire", fade_b3:"Swinguez le long de votre ligne corporelle, pas vers la cible", fade_b4:"Laissez la face rester ouverte un instant de plus a l'impact",
    fade_b1_left:"Alignez pieds, hanches et epaules legerement a droite de la cible", fade_b2_left:"Affaiblissez legerement le grip — tournez les deux mains un peu dans le sens horaire",
    ...
    prog_slice_technical:"Le slice survient quand la face du club est ouverte par rapport au plan de swing a l'impact — la face compte plus que le plan.",
    slice_b1:"Corrigez d'abord la face : renforcez le grip jusqu'a voir 2-3 jointures sur la main avant a l'adresse", slice_b2:"Demarrez la descente avec les hanches, pas les epaules", slice_b3:"Gardez le coude arriere proche du corps en descente", slice_b4:"Visez la cible, pas plus a gauche — viser a gauche aggrave le plan", slice_b5:"Laissez les avant-bras tourner a l'impact au lieu de garder la face ouverte",
    slice_b4_left:"Visez la cible, pas plus a droite — viser a droite aggrave le plan",
    ...
    prog_punchLow_technical:"Un punch reduit la trajectoire en deloftant la face a l'adresse, pas en swinguant plus fort.",
    punchLow_b1:"Placez la balle legerement en arriere dans la stance", punchLow_b2:"Avancez les mains devant la tete de club a l'adresse", punchLow_b3:"Faites un backswing aux trois-quarts", punchLow_b4:"Gardez la finition courte et basse",
    ...
    prog_flopLob_technical:"Un flop monte grace a une face ouverte et un swing engage — decelerer cause le rate, pas la technique.",
    flopLob_b1:"Ouvrez completement la face a l'adresse", flopLob_b2:"Utilisez votre wedge le plus loftee", flopLob_b3:"Faites un swing plus long et accelerant qui glisse sous la balle", flopLob_b4:"Engagez-vous completement — n'essayez jamais d'aider la balle a monter",
    ...
    prog_bunker_technical:"Les coups de bunker se gagnent ou se perdent au point d'entree dans le sable, jamais a la balle.",
    bunker_b1:"Ouvrez la face avant de prendre votre grip", bunker_b2:"Visez 2-3cm derriere la balle, pas la balle elle-meme", bunker_b3:"Laissez le bounce glisser dans le sable — ne creusez jamais", bunker_b4:"Choisissez votre point d'entree et engagez-vous, meme nerveux",
    ...
    prog_yips_technical:"Les yips combinent une composante physique (tension musculaire) et une mentale (peur de rater) — chercher une solution mecanique aggrave generalement le probleme.",
    yips_b1:"Reconstruisez la confiance a tres courte distance d'abord (putts de 30cm)", yips_b2:"Ralentissez votre respiration avant chaque coup", yips_b3:"Jugez-vous sur la routine, pas sur le resultat", yips_b4:"Resistez a l'envie de changer de grip ou d'equipement en pleine session",
  ...
  es: {
    ...
    per18Holes:"por 18 hoyos", downMeansImproving:"Linea descendente = mejorando (menos 3-putts)",
    ...
    programs:"Programas Predefinidos", steps:"pasos", programSteps:"Que incluye este programa", startProgram:"Iniciar programa", programComplete:"Programa completado", saveAndNext:"Guardar y siguiente", exitProgram:"Salir del programa", technicalPoint:"El punto tecnico",
    prog_warmup_name:"Calentamiento de Competicion", prog_warmup_desc:"Una secuencia estructurada antes de la ronda — putts cortos para el toque, chip basico para el contacto, control de alineacion, ejercicio de tempo, y reinicio de rutina. De lo pequeno a lo grande, el cuerpo antes del swing, exactamente como se organizan los profesionales.",
    prog_warmup_technical:"Esto es preparacion, no practica — el objetivo es ritmo y toque, no cambios de swing.",
    warmup_b1:"Trabaja de palos cortos a largos: wedge, luego hierro, luego driver", warmup_b2:"Empieza a media velocidad, aumenta gradualmente", warmup_b3:"Sin pensamientos tecnicos — solo ritmo y contacto", warmup_b4:"Termina en el green de practica, no en el rango",
    ...
    prog_draw_technical:"Un draw curva de derecha a izquierda porque la cara del palo esta cerrada respecto a un plano de swing de adentro hacia afuera.",
    draw_b1:"Alinea pies, caderas y hombros ligeramente a la derecha del objetivo", draw_b2:"Refuerza un poco el agarre — gira ambas manos un poco en sentido horario", draw_b3:"Haz swing por tu linea corporal, no hacia el objetivo", draw_b4:"Deja que la curva ocurra — no cierres la cara manualmente en el impacto",
    draw_b1_left:"Alinea pies, caderas y hombros ligeramente a la izquierda del objetivo", draw_b2_left:"Refuerza un poco el agarre — gira ambas manos un poco en sentido antihorario",
    ...
    prog_fade_technical:"Un fade curva de izquierda a derecha porque la cara del palo esta ligeramente abierta respecto a un plano de swing de afuera hacia adentro.",
    fade_b1:"Alinea pies, caderas y hombros ligeramente a la izquierda del objetivo", fade_b2:"Debilita un poco el agarre — gira ambas manos un poco en sentido antihorario", fade_b3:"Haz swing por tu linea corporal, no hacia el objetivo", fade_b4:"Deja que la cara permanezca abierta una fraccion mas en el impacto",
    fade_b1_left:"Alinea pies, caderas y hombros ligeramente a la derecha del objetivo", fade_b2_left:"Debilita un poco el agarre — gira ambas manos un poco en sentido horario",
    ...
    prog_slice_technical:"El slice ocurre cuando la cara del palo esta abierta respecto al plano de swing en el impacto — la cara importa mas que el plano.",
    slice_b1:"Corrige primero la cara: refuerza el agarre hasta ver 2-3 nudillos en la mano guia en la direccion", slice_b2:"Empieza la bajada con las caderas, no con los hombros", slice_b3:"Mantén el codo trasero cerca del cuerpo en la bajada", slice_b4:"Apunta al objetivo, no mas a la izquierda — apuntar a la izquierda empeora el plano", slice_b5:"Deja que los antebrazos giren en el impacto en lugar de mantener la cara abierta",
    slice_b4_left:"Apunta al objetivo, no mas a la derecha — apuntar a la derecha empeora el plano",
    ...
    prog_punchLow_technical:"Un punch reduce la trayectoria deslofteando la cara en la direccion, no golpeando mas fuerte.",
    punchLow_b1:"Coloca la bola un poco atras en tu postura", punchLow_b2:"Adelanta las manos delante de la cabeza del palo en la direccion", punchLow_b3:"Haz un backswing de tres cuartos", punchLow_b4:"Mantén el seguimiento corto y bajo",
    ...
    prog_flopLob_technical:"Un flop sube gracias a una cara abierta y un swing comprometido — desacelerar causa el fallo, no la tecnica.",
    flopLob_b1:"Abre completamente la cara en la direccion", flopLob_b2:"Usa tu wedge con mas loft", flopLob_b3:"Haz un swing mas largo y acelerando que se deslice bajo la bola", flopLob_b4:"Comprometete por completo — nunca intentes ayudar a la bola a subir",
    ...
    prog_bunker_technical:"Los golpes de bunker se ganan o pierden en el punto de entrada en la arena, nunca en la bola misma.",
    bunker_b1:"Abre la cara antes de tomar tu agarre", bunker_b2:"Apunta 2-3cm detras de la bola, no a la bola", bunker_b3:"Deja que el bounce deslice por la arena — nunca excaves", bunker_b4:"Elige tu punto de entrada y comprometete, aunque estes nervioso",
    ...
    prog_yips_technical:"Los yips combinan un componente fisico (tension muscular) y uno mental (miedo a fallar) — buscar un arreglo mecanico suele empeorarlo.",
    yips_b1:"Reconstruye la confianza a distancia muy corta primero (putts de 30cm)", yips_b2:"Ralentiza tu respiracion antes de cada golpe", yips_b3:"Juzgate por la rutina, no por si entra o no", yips_b4:"Resiste el impulso de cambiar agarre o equipo a mitad de sesion",
  ...
  de: {
    ...
    per18Holes:"pro 18 Loecher", downMeansImproving:"Abwaertstrend = Verbesserung (weniger 3-Putts)",
    ...
    programs:"Vorgefertigte Programme", steps:"Schritte", programSteps:"Inhalt dieses Programms", startProgram:"Programm starten", programComplete:"Programm abgeschlossen", saveAndNext:"Speichern & weiter", exitProgram:"Programm beenden", technicalPoint:"Der technische Punkt",
    prog_warmup_name:"Wettkampf-Aufwaermen", prog_warmup_desc:"Eine strukturierte Sequenz vor der Runde — kurze Putts fuer das Gefuehl, ein einfacher Chip fuer den Kontakt, eine Ausrichtungspruefung, eine Tempo-Uebung, dann ein Routine-Reset. Klein zu gross, Koerper vor Schwung, genau wie es Tour-Profis machen.",
    prog_warmup_technical:"Das ist Vorbereitung, kein Training — das Ziel ist Rhythmus und Gefuehl, keine Schwungaenderungen.",
    warmup_b1:"Arbeite von kurzen zu langen Schlaegern: Wedge, dann Eisen, dann Driver", warmup_b2:"Beginne bei halbem Tempo, steigere dich schrittweise", warmup_b3:"Keine technischen Gedanken — nur Rhythmus und Kontakt", warmup_b4:"Beende auf dem Putting Green, nicht auf der Range",
    ...
    prog_draw_technical:"Ein Draw kurvt rechts nach links, weil die Schlagflaeche zu einem Innen-nach-Aussen-Schwungplan geschlossen ist.",
    draw_b1:"Richte Fuesse, Huefte und Schultern leicht rechts vom Ziel aus", draw_b2:"Verstaerke den Griff etwas — drehe beide Haende leicht im Uhrzeigersinn", draw_b3:"Schwinge entlang deiner Koerperlinie, nicht zum Ziel", draw_b4:"Lass die Kurve passieren — schliesse die Flaeche nicht manuell beim Treffmoment",
    draw_b1_left:"Richte Fuesse, Huefte und Schultern leicht links vom Ziel aus", draw_b2_left:"Verstaerke den Griff etwas — drehe beide Haende leicht gegen den Uhrzeigersinn",
    ...
    prog_fade_technical:"Ein Fade kurvt links nach rechts, weil die Schlagflaeche leicht zu einem Aussen-nach-Innen-Schwungplan offen ist.",
    fade_b1:"Richte Fuesse, Huefte und Schultern leicht links vom Ziel aus", fade_b2:"Schwaeche den Griff etwas — drehe beide Haende leicht gegen den Uhrzeigersinn", fade_b3:"Schwinge entlang deiner Koerperlinie, nicht zum Ziel", fade_b4:"Lass die Flaeche beim Treffmoment einen Moment laenger offen bleiben",
    fade_b1_left:"Richte Fuesse, Huefte und Schultern leicht rechts vom Ziel aus", fade_b2_left:"Schwaeche den Griff etwas — drehe beide Haende leicht im Uhrzeigersinn",
    ...
    prog_slice_technical:"Ein Slice entsteht, wenn die Schlagflaeche zum Schwungplan offen ist — die Flaeche zaehlt mehr als der Plan.",
    slice_b1:"Korrigiere zuerst die Flaeche: verstaerke den Griff, bis du 2-3 Knoechel an der fuehrenden Hand im Setup siehst", slice_b2:"Starte den Abschwung mit der Huefte, nicht den Schultern", slice_b3:"Halte den hinteren Ellbogen nah am Koerper im Abschwung", slice_b4:"Ziele auf das Ziel, nicht weiter links — links zielen verschlimmert den Plan", slice_b5:"Lass die Unterarme beim Treffmoment rotieren, statt die Flaeche offen zu halten",
    slice_b4_left:"Ziele auf das Ziel, nicht weiter rechts — rechts zielen verschlimmert den Plan",
    ...
    prog_punchLow_technical:"Ein Punch reduziert die Flugbahn durch Entlofting der Flaeche im Setup, nicht durch haerteres Schlagen.",
    punchLow_b1:"Platziere den Ball etwas weiter hinten im Stand", punchLow_b2:"Fuehre die Haende vor dem Schlaegerkopf im Setup", punchLow_b3:"Mache einen Dreiviertel-Rueckschwung", punchLow_b4:"Halte den Durchschwung kurz und niedrig",
    ...
    prog_flopLob_technical:"Ein Flop kommt durch eine offene Flaeche und einen engagierten Schwung hoch — Abbremsen verursacht den Fehlschlag, nicht die Technik.",
    flopLob_b1:"Oeffne die Schlagflaeche vollstaendig im Setup", flopLob_b2:"Nutze deinen am hoechsten geloofteten Wedge", flopLob_b3:"Mache einen laengeren, beschleunigenden Schwung, der unter den Ball gleitet", flopLob_b4:"Engagiere dich voll — versuche nie, dem Ball hochzuhelfen",
    ...
    prog_bunker_technical:"Bunkerschlaege werden am Eintrittspunkt in den Sand entschieden, niemals am Ball selbst.",
    bunker_b1:"Oeffne die Flaeche, bevor du den Griff nimmst", bunker_b2:"Ziele 2-3cm hinter den Ball, nicht auf den Ball", bunker_b3:"Lass den Bounce durch den Sand gleiten — grabe niemals", bunker_b4:"Waehle deinen Eintrittspunkt und engagiere dich, auch wenn du nervoes bist",
    ...
    prog_yips_technical:"Die Yips kombinieren eine physische Komponente (Muskelspannung) und eine mentale (Angst vor dem Verfehlen) — eine mechanische Loesung zu suchen verschlimmert es meist.",
    yips_b1:"Baue das Vertrauen zuerst auf sehr kurzer Distanz wieder auf (30cm-Putts)", yips_b2:"Verlangsame deine Atmung vor jedem Schlag", yips_b3:"Bewerte dich an der Routine, nicht ob es hineingeht", yips_b4:"Widerstehe dem Drang, Griff oder Ausruestung mitten in der Sitzung zu wechseln",
  ...
  it: {
    ...
    per18Holes:"per 18 buche", downMeansImproving:"Linea in discesa = miglioramento (meno 3-putt)",
    ...
    programs:"Programmi Predefiniti", steps:"passaggi", programSteps:"Cosa contiene questo programma", startProgram:"Inizia programma", programComplete:"Programma completato", saveAndNext:"Salva e avanti", exitProgram:"Esci dal programma", technicalPoint:"Il punto tecnico",
    prog_warmup_name:"Riscaldamento da Competizione", prog_warmup_desc:"Una sequenza strutturata prima del round — putt corti per il tocco, chip base per il contatto, controllo dell'allineamento, esercizio di tempo, poi reset della routine. Dal piccolo al grande, il corpo prima dello swing, esattamente come si organizzano i professionisti.",
    prog_warmup_technical:"Questa e preparazione, non allenamento — l'obiettivo e ritmo e tocco, non cambiamenti di swing.",
    warmup_b1:"Lavora dai bastoni corti ai lunghi: wedge, poi ferro, poi driver", warmup_b2:"Inizia a meta velocita, aumenta gradualmente", warmup_b3:"Nessun pensiero tecnico — solo ritmo e contatto", warmup_b4:"Finisci sul green di allenamento, non al campo pratica",
    ...
    prog_draw_technical:"Un draw curva da destra a sinistra perche la faccia del bastone e chiusa rispetto a un piano di swing da dentro verso fuori.",
    draw_b1:"Allinea piedi, fianchi e spalle leggermente a destra dell'obiettivo", draw_b2:"Rinforza leggermente la presa — gira entrambe le mani un po' in senso orario", draw_b3:"Swing lungo la tua linea corporea, non verso l'obiettivo", draw_b4:"Lascia che la curva accada — non chiudere manualmente la faccia all'impatto",
    draw_b1_left:"Allinea piedi, fianchi e spalle leggermente a sinistra dell'obiettivo", draw_b2_left:"Rinforza leggermente la presa — gira entrambe le mani un po' in senso antiorario",
    ...
    prog_fade_technical:"Un fade curva da sinistra a destra perche la faccia del bastone e leggermente aperta rispetto a un piano di swing da fuori verso dentro.",
    fade_b1:"Allinea piedi, fianchi e spalle leggermente a sinistra dell'obiettivo", fade_b2:"Indebolisci leggermente la presa — gira entrambe le mani un po' in senso antiorario", fade_b3:"Swing lungo la tua linea corporea, non verso l'obiettivo", fade_b4:"Lascia che la faccia resti aperta un istante di piu all'impatto",
    fade_b1_left:"Allinea piedi, fianchi e spalle leggermente a destra dell'obiettivo", fade_b2_left:"Indebolisci leggermente la presa — gira entrambe le mani un po' in senso orario",
    ...
    prog_slice_technical:"Lo slice accade quando la faccia del bastone e aperta rispetto al piano di swing all'impatto — la faccia conta piu del piano.",
    slice_b1:"Correggi prima la faccia: rinforza la presa finche non vedi 2-3 nocche sulla mano guida all'indirizzo", slice_b2:"Inizia la discesa con i fianchi, non le spalle", slice_b3:"Tieni il gomito posteriore vicino al corpo in discesa", slice_b4:"Punta all'obiettivo, non piu a sinistra — puntare a sinistra peggiora il piano", slice_b5:"Lascia che gli avambracci ruotino all'impatto invece di mantenere la faccia aperta",
    slice_b4_left:"Punta all'obiettivo, non piu a destra — puntare a destra peggiora il piano",
    ...
    prog_punchLow_technical:"Un punch riduce la traiettoria deloftando la faccia all'indirizzo, non colpendo piu forte.",
    punchLow_b1:"Posiziona la palla leggermente piu indietro nella stance", punchLow_b2:"Porta le mani avanti rispetto alla testa del bastone all'indirizzo", punchLow_b3:"Fai un backswing di tre quarti", punchLow_b4:"Mantieni il seguito corto e basso",
    ...
    prog_flopLob_technical:"Un flop sale grazie a una faccia aperta e uno swing impegnato — decelerare causa l'errore, non la tecnica.",
    flopLob_b1:"Apri completamente la faccia all'indirizzo", flopLob_b2:"Usa il tuo wedge con piu loft", flopLob_b3:"Fai uno swing piu lungo e accelerante che scivola sotto la palla", flopLob_b4:"Impegnati completamente — non cercare mai di aiutare la palla a salire",
    ...
    prog_bunker_technical:"I colpi di bunker si vincono o si perdono al punto di ingresso nella sabbia, mai sulla palla.",
    bunker_b1:"Apri la faccia prima di prendere la presa", bunker_b2:"Punta 2-3cm dietro la palla, non sulla palla", bunker_b3:"Lascia che il bounce scivoli nella sabbia — non scavare mai", bunker_b4:"Scegli il tuo punto di ingresso e impegnati, anche se sei nervoso",
    ...
    prog_yips_technical:"I yips combinano una componente fisica (tensione muscolare) e una mentale (paura di sbagliare) — cercare una soluzione meccanica di solito peggiora le cose.",
    yips_b1:"Ricostruisci prima la fiducia a distanza molto corta (putt da 30cm)", yips_b2:"Rallenta la respirazione prima di ogni colpo", yips_b3:"Giudicati sulla routine, non se entra o no", yips_b4:"Resisti all'impulso di cambiare presa o attrezzatura a meta sessione",
  ...
  pt: {
    ...
    per18Holes:"por 18 buracos", downMeansImproving:"Linha descendo = melhorando (menos 3-putts)",
    ...
    programs:"Programas Predefinidos", steps:"etapas", programSteps:"O que tem neste programa", startProgram:"Iniciar programa", programComplete:"Programa concluido", saveAndNext:"Salvar e proximo", exitProgram:"Sair do programa", technicalPoint:"O ponto tecnico",
    prog_warmup_name:"Aquecimento de Competicao", prog_warmup_desc:"Uma sequencia estruturada antes da rodada — putts curtos para o toque, chip basico para o contato, verificacao de alinhamento, exercicio de ritmo, e reinicio de rotina. Do pequeno ao grande, o corpo antes do swing, exatamente como os profissionais se organizam.",
    prog_warmup_technical:"Isso e preparacao, nao treino — o objetivo e ritmo e toque, nao mudancas no swing.",
    warmup_b1:"Trabalhe dos tacos curtos aos longos: wedge, depois ferro, depois driver", warmup_b2:"Comece em meia velocidade, aumente gradualmente", warmup_b3:"Nenhum pensamento tecnico — apenas ritmo e contato", warmup_b4:"Termine no green de putting, nao no campo de pratica",
    ...
    prog_draw_technical:"Um draw curva da direita para a esquerda porque a face do taco esta fechada em relacao a um plano de swing de dentro para fora.",
    draw_b1:"Alinhe pes, quadris e ombros levemente a direita do alvo", draw_b2:"Fortaleca um pouco o grip — gire ambas as maos levemente no sentido horario", draw_b3:"Faca o swing pela sua linha corporal, nao em direcao ao alvo", draw_b4:"Deixe a curva acontecer — nao feche a face manualmente no impacto",
    draw_b1_left:"Alinhe pes, quadris e ombros levemente a esquerda do alvo", draw_b2_left:"Fortaleca um pouco o grip — gire ambas as maos levemente no sentido anti-horario",
    ...
    prog_fade_technical:"Um fade curva da esquerda para a direita porque a face do taco esta levemente aberta em relacao a um plano de swing de fora para dentro.",
    fade_b1:"Alinhe pes, quadris e ombros levemente a esquerda do alvo", fade_b2:"Enfraqueca um pouco o grip — gire ambas as maos levemente no sentido anti-horario", fade_b3:"Faca o swing pela sua linha corporal, nao em direcao ao alvo", fade_b4:"Deixe a face ficar aberta um instante mais no impacto",
    fade_b1_left:"Alinhe pes, quadris e ombros levemente a direita do alvo", fade_b2_left:"Enfraqueca um pouco o grip — gire ambas as maos levemente no sentido horario",
    ...
    prog_slice_technical:"O slice acontece quando a face do taco esta aberta em relacao ao plano de swing no impacto — a face importa mais que o plano.",
    slice_b1:"Corrija primeiro a face: fortaleca o grip ate ver 2-3 nos dos dedos na mao guia no endereco", slice_b2:"Comece a descida com os quadris, nao os ombros", slice_b3:"Mantenha o cotovelo traseiro proximo ao corpo na descida", slice_b4:"Aponte para o alvo, nao mais a esquerda — apontar a esquerda piora o plano", slice_b5:"Deixe os antebracos girarem no impacto em vez de manter a face aberta",
    slice_b4_left:"Aponte para o alvo, nao mais a direita — apontar a direita piora o plano",
    ...
    prog_punchLow_technical:"Um punch reduz a trajetoria retirando loft da face no endereco, nao batendo mais forte.",
    punchLow_b1:"Posicione a bola um pouco mais atras na postura", punchLow_b2:"Avance as maos na frente da cabeca do taco no endereco", punchLow_b3:"Faca um backswing de tres quartos", punchLow_b4:"Mantenha o seguimento curto e baixo",
    ...
    prog_flopLob_technical:"Um flop sobe gracas a uma face aberta e um swing comprometido — desacelerar causa o erro, nao a tecnica.",
    flopLob_b1:"Abra completamente a face no endereco", flopLob_b2:"Use seu wedge com mais loft", flopLob_b3:"Faca um swing mais longo e acelerando que deslize sob a bola", flopLob_b4:"Comprometa-se totalmente — nunca tente ajudar a bola a subir",
    ...
    prog_bunker_technical:"Tacadas de bunker se ganham ou perdem no ponto de entrada na areia, nunca na bola em si.",
    bunker_b1:"Abra a face antes de pegar o grip", bunker_b2:"Aponte 2-3cm atras da bola, nao na bola", bunker_b3:"Deixe o bounce deslizar pela areia — nunca escave", bunker_b4:"Escolha seu ponto de entrada e se comprometa, mesmo nervoso",
    ...
    prog_yips_technical:"Os yips combinam um componente fisico (tensao muscular) e um mental (medo de errar) — buscar um ajuste mecanico geralmente piora a situacao.",
    yips_b1:"Reconstrua a confianca em distancia muito curta primeiro (putts de 30cm)", yips_b2:"Desacelere sua respiracao antes de cada tacada", yips_b3:"Julgue-se pela rotina, nao se a bola entra", yips_b4:"Resista ao impulso de mudar grip ou equipamento no meio da sessao",
            ...
            return (
              <div key={i} style={{background:i===0&&isGroup?"linear-gradient(135deg,#fff8e6,#fef0d8)":OFF,borderRadius:14,padding:"12px 16px",border:"1px solid "+(i===0&&isGroup?GOLD+"66":BORDER),display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                ...
                <div style={{textAlign:"right"}}>
                  <div style={{color:NAVY,fontSize:22,fontWeight:700,fontFamily:"Georgia,serif",lineHeight:1}}>{p.score}</div>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(10,20,40,0.75)",zIndex:200,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div style={{background:WHITE,borderRadius:"24px 24px 0 0",padding:24,width:"100%",maxWidth:500,maxHeight:"88vh",overflowY:"auto",boxShadow:"0 -8px 40px rgba(0,0,0,0.2)"}}>
        ...
        <div style={{background:PURPLE_BG,borderRadius:16,padding:18,marginBottom:16,textAlign:"center",border:"1px solid "+PURPLE+"33"}}>
          <div style={{color:NAVY,fontSize:42,fontWeight:700,fontFamily:"Georgia,serif",lineHeight:1}}>{session.score}<span style={{fontSize:16,color:SLATE_L}}>/{session.max}</span></div>
...
function ScorecardModal({session, onClose, lang}){
  ...
  const updownAttempts=holes.filter(h=>h.gir===false);
  const updownSuccess=updownAttempts.filter(h=>(h.putts||0)<=1);
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(10,20,40,0.75)",zIndex:200,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div style={{background:WHITE,borderRadius:"24px 24px 0 0",padding:24,width:"100%",maxWidth:500,maxHeight:"88vh",overflowY:"auto",boxShadow:"0 -8px 40px rgba(0,0,0,0.2)"}}>
        <div style={{width:36,height:4,background:BORDER,borderRadius:2,margin:"0 auto 18px"}}/>
...
function ScorecardEntry({holeCount, onSave, onCancel, lang, userId}){
  ...
  const [girWarning,setGirWarning]=useState(null); // hole index currently showing a GIR contradiction warning
  function upd(i,k,v){
    setHoles(p=>p.map((h,x)=>{
      if(x!==i) return h;
      const updated={...h,[k]:v};
      // Whenever par, score, putts, or gir itself changes, re-check whether
      // the GIR checkbox is still consistent with the numbers. If the player
      // is trying to check GIR on a combination that's mathematically
      // impossible (e.g. par 5, 3 putts, score 5 — that would require only
      // 2 non-putting strokes when par-2=3 are needed, so it can't be GIR),
      // block it and show a brief explanation instead of saving bad data.
      if(["par","score","putts","gir"].includes(k)){
        ...
        if(updated.gir && !possible){
          setGirWarning(i);
          setTimeout(()=>setGirWarning(g=>g===i?null:g),3500);
        ...
        <div style={{display:"flex",flexDirection:"column",gap:10}}>
          {holes.map((h,i)=>(
            <div key={i} style={{background:WHITE,borderRadius:14,padding:14,border:"1px solid "+BORDER}}>
              ...
              {girWarning===i&&(
                <div style={{background:"#fef0f0",border:"1px solid "+RED+"44",borderRadius:10,padding:"7px 10px",marginBottom:10,color:RED,fontSize:11,lineHeight:1.5}}>
                  {t(lang,"girImpossible")}
                </div>
              )}
...
function TrainTab({sessions, onSave, settings, userId, accountName, weaknesses, hand}){
  ...
  if(step==="programIntro"&&activeProgram) return (
    <div>
      ...
      <div style={{background:PURPLE_BG,borderRadius:16,padding:16,marginBottom:18,border:"1px solid "+PURPLE+"33"}}>
        <div style={{color:PURPLE,fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>{t(lang,"technicalPoint")}</div>
        <p style={{color:NAVY,fontSize:13,lineHeight:1.6,margin:"0 0 12px",fontWeight:600}}>{t(lang,"prog_"+activeProgram.id+"_technical")}</p>
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {(activeProgram.bulletKeys||[]).map((bk,i)=>{
            // If the player is left-handed and a mirrored version of this
            // specific bullet exists, use it — otherwise fall back to the
            // standard (right-handed-written) text, which is handedness-neutral
            // for bullets that don't reference a left/right direction at all.
            const mirroredKey = bk+"_left";
            const useKey = (hand==="Left" && t(lang,mirroredKey)!==mirroredKey) ? mirroredKey : bk;
            return (
              <div key={i} style={{display:"flex",gap:8,alignItems:"flex-start"}}>
                <span style={{color:PURPLE,fontSize:14,fontWeight:700,flexShrink:0,lineHeight:1.4}}>•</span>
                <span style={{color:TEXT,fontSize:13,lineHeight:1.5}}>{t(lang,useKey)}</span>
              </div>
            );
          })}
        </div>
        ...
        {(()=>{
          ...
          return (
            <div style={{display:"inline-block",background:WHITE,borderRadius:18,padding:"18px 28px",border:"1px solid "+BORDER,boxShadow:"0 2px 14px rgba(0,0,0,0.06)"}}>
              <div style={{color:NAVY,fontSize:38,fontWeight:700,fontFamily:"Georgia,serif",lineHeight:1}}>{totalScore}<span style={{fontSize:15,color:SLATE_L}}>/{totalMax}</span></div>
  ...
  if(step==="focus") return (
    <div>
      ...
      {(()=>{
        // Suggest one Program based on the player's first selected weakness
        // that has a mapped Program — surfaces the weaknesses they picked at
        // signup instead of leaving that data unused.
        const matchedWeakness = (weaknesses||[]).find(w=>WEAKNESS_TO_PROGRAM[w]);
        if(!matchedWeakness) return null;
        const recProgram = PROGRAMS.find(p=>p.id===WEAKNESS_TO_PROGRAM[matchedWeakness]);
        if(!recProgram) return null;
        return (
          <button onClick={()=>{setActiveProgram(recProgram);setProgramStepIdx(0);setStep("programIntro");}}
            style={{width:"100%",background:PURPLE_GRAD,border:"none",borderRadius:16,padding:"14px 16px",cursor:"pointer",textAlign:"left",display:"flex",alignItems:"center",gap:12,marginBottom:20,boxShadow:"0 3px 14px rgba(124,92,191,0.3)"}}>
            <div style={{width:40,height:40,background:"rgba(255,255,255,0.18)",borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",fontSize:19,flexShrink:0}}>{recProgram.emoji}</div>
            <div style={{flex:1}}>
              <div style={{color:"rgba(255,255,255,0.7)",fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:1}}>{t(lang,"recommendedForYou")}</div>
              <div style={{color:WHITE,fontWeight:700,fontSize:14}}>{t(lang,"prog_"+recProgram.id+"_name")}</div>
              <div style={{color:"rgba(255,255,255,0.65)",fontSize:11,marginTop:1}}>{t(lang,"basedOnWeakness")}: {t(lang,"weak_"+matchedWeakness)}</div>
            </div>
...
function ScoreTab({onSave, settings, sessions, userId}){
  ...
  return (
    <div>
      ...
      <ScorecardEntry holeCount={n} lang={lang} userId={userId} onCancel={()=>setStep("pick")}
...
function ScorecardHistoryDetail({rounds, lang, onBack}){
  ...
  const perRoundStats = ranged.map(r=>{
    ...
    const updownAttempts=holes.filter(h=>h.gir===false);
    const updownSuccess=updownAttempts.filter(h=>(h.putts||0)<=1);
    return { threePutts18:threePuttCount*scaleTo18, updowns18:updownSuccess.length*scaleTo18 };
  });
  const threePuttTrend = perRoundStats.map(r=>Math.round(r.threePutts18*10)/10);
  const updownTrend = perRoundStats.map(r=>Math.round(r.updowns18*10)/10);
  ...
  const avgUpdown = ranged.length ? Math.round((updownTrend.reduce((a,b)=>a+b,0)/ranged.length)*10)/10 : null;
      ...
      {ranged.length===0 ? (
        ...
        <>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:18}}>
            {[[t(lang,"avgScore"),avgScore!=null?(avgScore>=0?"+":"")+avgScore:"—",avgScore!=null&&avgScore<=0?GREEN:avgScore!=null&&avgScore<=5?AMBER:RED],[t(lang,"threePutts"),avgThreePutts??"—",null],[t(lang,"upAndDown"),avgUpdown??"—",null]].map(([l,v,c])=>(
              <div key={l} style={{background:WHITE,borderRadius:14,padding:"12px 8px",textAlign:"center",border:"1px solid "+BORDER}}>
                ...
                <div style={{color:c||NAVY,fontSize:19,fontWeight:700,fontFamily:"Georgia,serif"}}>{v}</div>
              </div>
            ))}
          </div>

          {scoreTrend.length>1&&(
            <div style={{background:WHITE,borderRadius:16,padding:16,marginBottom:12,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.04)"}}>
              <div style={{color:NAVY,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>{t(lang,"scoreVsPar")}</div>
          ...
          {threePuttTrend.length>1&&(
            <div style={{background:WHITE,borderRadius:16,padding:16,marginBottom:12,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.04)"}}>
              <div style={{color:NAVY,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>{t(lang,"threePutts")}</div>
              <div style={{color:SLATE_L,fontSize:10,marginBottom:10}}>{t(lang,"downMeansImproving")}</div>
              <Sparkline data={threePuttTrend} color={RED} invert/>
            </div>
          )}
          {updownTrend.length>1&&(
            <div style={{background:WHITE,borderRadius:16,padding:16,marginBottom:18,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.04)"}}>
              <div style={{color:NAVY,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>{t(lang,"upAndDown")}</div>
              <div style={{color:SLATE_L,fontSize:10,marginBottom:10}}>{t(lang,"upMeansImproving")}</div>
              <Sparkline data={updownTrend} color={GREEN}/>
            </div>
          )}
...
function StatsTab({sessions, lang, hdcp, onGoTrain, onGoScore}){
  ...
  const perRoundStats = rounds.map(r=>{
    ...
    const threePuttCount = holes.filter(h=>(h.putts||0)>=3).length;
    // Up & down = missed the green in regulation, then needed 1 putt or fewer
    // to finish the hole. This is the actual definition — it does not depend
    // on score relative to par at all, just GIR miss + a quick finish.
    const updownAttempts = holes.filter(h=>h.gir===false);
    const updownSuccess = updownAttempts.filter(h=>(h.putts||0)<=1);
    return {
      ts: r.ts,
  ...
  const updownAvg = perRoundStats.length
    ...
    : null;
  // Trend data for charting, oldest to newest, each value already per-round
  // (18-hole-normalized) rather than cumulative. Charts show the LAST 10
  // rounds for readability — the averages above them (threePuttAvg, updownAvg)
  // are deliberately separate and use full all-time history, uncapped.
  const threePuttTrend = [...perRoundStats].sort((a,b)=>a.ts-b.ts).slice(-10).map(r=>Math.round(r.threePutts18*10)/10);
  const updownTrend = [...perRoundStats].sort((a,b)=>a.ts-b.ts).slice(-10).map(r=>Math.round(r.updowns18*10)/10);
  ...
  const roundsChrono=[...rounds].sort((a,b)=>a.ts-b.ts);
  const scoreTrend=roundsChrono.slice(-10).map(r=>{
    const tot=(r.holes||[]).reduce((a,h)=>a+(h.score||0),0);
    const par=(r.holes||[]).reduce((a,h)=>a+(h.par||0),0);
    return tot-par;
  });
    ...
    <div>
      ...
      {rounds.length>0&&(
        <div style={{marginBottom:20}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
            {[[t(lang,"avgPutts"),avgP||"—",t(lang,"per18Holes"),null],["GIR %",girPct!=null?girPct+"%":"—",t(lang,"greens"),null],["FIR %",firPct!=null?firPct+"%":"—",t(lang,"fairways"),null],[t(lang,"topMiss"),topM&&topM[1]>0?t(lang,topM[0]+"_dir"):"—",t(lang,"common"),topM&&topM[1]>0?RED:null],[t(lang,"threePutts"),threePuttAvg!=null?threePuttAvg:"—",t(lang,"per18Holes"),threePuttAvg!=null&&threePuttAvg>2?RED:null],[t(lang,"upAndDown"),updownAvg!=null?updownAvg:"—",t(lang,"per18Holes"),null]].map(([l,v,s,a])=>(
          ...
          {threePuttTrend.length>1&&(
            <div style={{background:WHITE,borderRadius:16,padding:16,marginBottom:4,marginTop:10,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.04)"}}>
              <div style={{color:NAVY,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>{t(lang,"threePutts")} — {t(lang,"lastRounds")} {threePuttTrend.length} {t(lang,"rounds")}</div>
              <div style={{color:SLATE_L,fontSize:10,marginBottom:10}}>{t(lang,"downMeansImproving")}</div>
              <Sparkline data={threePuttTrend} color={RED} invert/>
              <div style={{display:"flex",justifyContent:"space-around",marginTop:10}}>
                {threePuttTrend.map((v,i)=>(
                  <div key={i} style={{color:v<=1?GREEN:v<=2?AMBER:RED,fontWeight:700,fontSize:12,fontFamily:"Georgia,serif"}}>{v}</div>
                ))}
              </div>
            </div>
          )}
          {updownTrend.length>1&&(
            <div style={{background:WHITE,borderRadius:16,padding:16,marginBottom:4,marginTop:10,border:"1px solid "+BORDER,boxShadow:"0 1px 8px rgba(0,0,0,0.04)"}}>
              <div style={{color:NAVY,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>{t(lang,"upAndDown")} — {t(lang,"lastRounds")} {updownTrend.length} {t(lang,"rounds")}</div>
              <div style={{color:SLATE_L,fontSize:10,marginBottom:10}}>{t(lang,"upMeansImproving")}</div>
              <Sparkline data={updownTrend} color={GREEN}/>
              <div style={{display:"flex",justifyContent:"space-around",marginTop:10}}>
                {updownTrend.map((v,i)=>(
                  <div key={i} style={{color:NAVY,fontWeight:700,fontSize:12,fontFamily:"Georgia,serif"}}>{v}</div>
                ))}
              </div>
            </div>
          )}
...
function PlayerTab({user, onSave, settings, onSaveSettings, onLogout, onResetDemo}){
...
function seedDemoData(){
  try{
    ...
    const user = {
      id:"u_demo_edouard", name:"Edouard L", email:"", pass:"",
      hdcp:"2.0", freq:"f23", photo:"", goal:"break80", weaknesses:["bunker","mental"],
      homeClub:"", location:"", typicalScore:"70_74", hand:"Right"
    };
    ...
    // ── 100 training exercise sessions, spread across the last 90 days,
    // drawing from all 50 exercises (each one used ~2x on average). Scores
    // trend upward gently — a 2.0 handicap player is already skilled, so the
    // curve starts around 70% and climbs to ~90%, not the steep beginner ramp
    // used in earlier demo profiles.
    const ALL_EX = [
    ...
    for(let i=0;i<100;i++){
      ...
      const progress = i/99;
      const basePct = 0.68 + progress*0.24; // 68% -> 92%
      ...
      const daysAgo = 90 - Math.round((i/99)*89);
    ...
    for(let i=0;i<40;i++){
      ...
      const progress = i/39;
      const basePct = 0.66 + progress*0.26; // 66% -> 92%
      ...
      const daysAgo = 88 - Math.round((i/39)*86);
    ...
    // ── 50 Finisher sessions across the 3 games, mixing solo and multiplayer
    // (with Alban L and Simon M joining roughly a third of the time each),
    // spread across the last 90 days, Edouard's scores trending up from a
    // strong baseline (matching a 2.0 handicap player's short game/putting).
    const FIN_GAMES = [
    ...
    for(let i=0;i<50;i++){
      ...
      const progress = i/49;
      const basePct = 0.70 + progress*0.22; // 70% -> 92%
      ...
      const daysAgo = 89 - Math.round((i/49)*87);
    ...
    // 30 rounds use 30 DISTINCT courses rather than allowing repeats — there
    // are 53 real courses available, comfortably more than the 30 needed.
    ...
    function genRound(course, daysAgo, seedBase, feeling){
      const holeCount = 18;
      ...
      // Clamp to 69-81 by nudging the holes with the largest |rel| first, so
      // the round still reads naturally rather than uniformly shifting every hole.
      const target = Math.max(69, Math.min(81, total));
      ...
      const finalHoles = holes.map((h,i)=>{
        // IMPORTANT: r2/r3 here must be independent draws from whatever
        ...
        if(h.rel<=-1){
          // Birdie or better: almost always GIR + 1 putt (occasionally a
          // chip-in from just off the green, which still counts as missed GIR).
          if(r2>0.12){ gir=true; putts=1; approachStrokes = (h.par<=3?1:h.par-2); }
          else { gir=false; putts=0; approachStrokes = (h.par<=3?1:h.par-2)+1; } // chip-in
        } else if(h.rel===0){
          // Par: GIR + 2 putts most of the time, or missed green + great up-and-down.
          if(r2>0.22){ gir=true; putts=2; approachStrokes = (h.par<=3?1:h.par-2); }
          else { gir=false; putts=1; approachStrokes = (h.par<=3?1:h.par-2)+1; }
        } else if(h.rel===1){
          // Bogey: missed green + 2 putts (most common ~70%), GIR + 3-putt
          // (~20% — a 2.0 handicap still 3-putts sometimes, even off good
          // approach play), or missed green + 1 putt but a longer approach (~10%).
          if(r2<0.20){ gir=true; putts=3; approachStrokes = (h.par<=3?1:h.par-2); }
          else if(r2<0.90){ gir=false; putts=2; approachStrokes = (h.par<=3?1:h.par-2)+1; }
          else { gir=false; putts=1; approachStrokes = (h.par<=3?1:h.par-2)+2; }
        } else {
          ...
          gir=false; putts = r2<0.65?2:3; approachStrokes = (h.par<=3?1:h.par-2) + (h.rel - (putts-2));
        }
        const score = approachStrokes + putts;
        const fir = h.par>3 ? r3>0.25 : null;
      ...
      return {type:"round", holes:finalHoles, n:holeCount, course:course.name, feeling, notes:"", ts: now - daysAgo*DAY};
    }
    const FEELINGS = ["focused","relaxed","neutral","pumped","anxious","tired"];
    const roundSessions = [];
    for(let i=0;i<30;i++){
      const course = pickCourse(i+1);
      const daysAgo = 89 - Math.round((i/29)*87);
      const feeling = FEELINGS[i % FEELINGS.length];
      roundSessions.push(genRound(course, daysAgo, i+1, feeling));
    }
  ...
  return (
    <div style={{minHeight:"100vh",background:OFF,fontFamily:"'Inter',system-ui,sans-serif",color:TEXT,display:"flex",flexDirection:"column",maxWidth:500,margin:"0 auto"}}>
      ...
      <div style={{flex:1,padding:"20px 18px 110px",overflowY:"auto"}}>
        {tab==="train"&&<TrainTab sessions={sessions} onSave={addSession} settings={settings} userId={user.id} accountName={user.name} weaknesses={user.weaknesses} hand={user.hand}/>}
        ...
        {tab==="player"&&<PlayerTab user={user} onSave={saveUser} settings={settings} onSaveSettings={saveSettings} onLogout={logout} onResetDemo={resetDemoData}/>}
      </div>
    </div>
  );
}
